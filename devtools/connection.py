...
class Connection:
    def __init__(self, browser_process):
        ...
        self._list_session_id = []

    def create_tab(self):
        str_uuid = str(uuid.uuid4())
        self._list_session_id = self._list_session_id.append(str_uuid)
    ...
    def open_tab(self):
        ...
        for session_id, session_instance in self._list_session_id, self.tab_sessions:
